  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>clogin/ingresar" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="txt_usuario" placeholder="Ingrese su Usuario">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>

      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="txt_clave" placeholder="Password">
